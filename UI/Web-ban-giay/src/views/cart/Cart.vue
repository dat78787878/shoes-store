                    ...
                    <tbody>
                        <tr v-for="(order,index) in orders" :key="index" class="tr">
                            ...
                            <td>
                                <div class="product-many">
                                    <div class="quanty form-group">
                                        <div class="inputNumberMinus value-button down-btns btn-plus" value="Decrease Value" @click="minusOrderSize(index)">−</div>
                                        <div style="padding-left:15px;padding-right:15px">{{ order.size }}</div>
                                        <div class="inputNumberPlus value-button up-btns btn-minus" value="Increase Value" @click="plusOrderSize(index)">+</div>
                                    </div>
                                </div>
                            </td>
                             <td>
                                <div class="product-many">
                                    <div class="quanty form-group">
                                        ...
                                        <div style="padding-left:15px;padding-right:15px">{{ order.color }}</div>
...
export default {
    ...
    methods: {
        ...
        plusOrder(index) {
         ...
         /**
         * Hàm sử lí việc giảm size
         */
        minusOrderSize(index) {
            const me = this;
            if (me.orders[index].size > 35) {
                me.orders[index].size -= 1;
            } else {
        ...
        /**
         * Hàm sử lí việc tăng size
         */
        plusOrderSize(index) {
            const me = this;
            if (me.orders[index].size <= 44) {
                me.orders[index].size += 1;
            }
        },
        /**
