...
public interface ProductRepo extends BaseRepo<Product>{
    @Query(value = "proc_get_products_filter ?1,?2,?3,?4,?5,?6,?7 ", nativeQuery = true)
    ...
    @Query(value = "proc_get_products_top_selling", nativeQuery = true)
    public List<Product> getTopSellings();
