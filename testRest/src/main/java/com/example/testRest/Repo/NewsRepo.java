...
public interface NewsRepo extends BaseRepo<News>{
    ...
    @Query(value = "proc_get_news_event", nativeQuery = true)
    public List<News> getEvents();
    
    @Query(value = "proc_get_news_sale", nativeQuery = true)
    public List<News> getSales();
    
    @Query(value = "proc_get_news_home", nativeQuery = true)
    public List<News> getHomes();
    
    @Query(value = "proc_get_news_hot", nativeQuery = true)
    public List<News> getHots();
    
    @Query(value = "proc_get_news_product", nativeQuery = true)
    public List<News> getProducts();
    
    @Query(value = "proc_get_newss_filter ?1,?2,?3", nativeQuery = true)
